                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 all-result-sec">
                    ...
                    <div class="adv-sale py-4">
                        <div class="container">
                            <div id="myDiv">
                                <button class="close"
                                    onclick="document.getElementById('myDiv').style.display='none'"> X </button>
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-8">
                                        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                            <ol class="carousel-indicators">
                                                @foreach (\App\Models\Adv::where('status', '0')->orderBy('id', 'desc')->get() as $advs)
                                            ...
                                            <div class="carousel-inner" role="listbox">
                                                @foreach (\App\Models\Adv::where('status', '0')->where('country', $member->country)->orderBy('id', 'desc')->get() as $advs)
                    ...
                    <div class="row mt-2">
                        <div class="col-xs-12 col-sm-12 col-md-6 mt-2">
                            <p>الاعضاء المميزون في مصر<span> {{ $members_counts }}</span></p>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-6 mt-2">
                            <div class="row">
                                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-4 mt-2">
                                    <img src="{{ asset('app-assets/images/Group 27801.png') }}" /><a
                                        href="{{ route('who_visit_myprofile') }}" class="link-result-1">الكل</a>
                                </div>
                                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-4 mt-2">
                                    <img src="{{ asset('app-assets/images/Group 278011.png') }}" /><a href="#"
                                        class="link-result-1">ذكر</a>
                                </div>
                                <div class="col-xs-6 col-sm-6 col-md-6 col-lg-4 mt-2">
                                    <img src="{{ asset('app-assets/images/Group 2780111.png') }}" /><a href="#"
                                        class="link-result-1">انثى</a>
                                </div>
                            </div>
                        </div>
                    </div>
