        ...
        <div class="container container-1">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 col-info-1">
                    ...
                    {{-- <a href="#" class="condition-sec">الشروط والاحكام</a>
                    <div class="form-login  py-4">
                        <div class="row">
                            <div class="col">
                                <form>
                                    <input type="radio" class="radio-sec" required>
                                    <label for="html" class="hidden-entrance">اوافق على جميع الشروط والاحكام</label>
                                </form>
                            </div>
                        </div>
                    </div> --}}
