                                        ...
                                        <div class="card" style="width: 100%">
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <button data-toggle="modal" data-target="#block{{ $blocked_member->member_id }}" class="block" title="الغاء الحظر">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('member_give_like', 'test') }}" method="post">
                        ...
                        <input id="member_id" type="hidden" name="member_id" class="form-control"
                            value="{{ $member->id }}">

                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary"
                                data-dismiss="modal">{{ trans('admins_trans.Close') }}</button>
                            <button type="submit" class="btn btn-success">{{ __('تـأكـيـد') }}</button>
                        </div>
                    </form>
