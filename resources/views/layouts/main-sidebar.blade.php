                ...
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#members-icon">
                            <div class="pull-left"><i class="fas fa-users"></i><span class="right-nav-text">{{__('الاعـضـاء')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#packages-icon">
                            <div class="pull-left"><i class="fas fa-users"></i><span class="right-nav-text">{{__('باقات التمييز')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#success_relations-icon">
                            <div class="pull-left"><i class="fas fa-users"></i><span class="right-nav-text">{{__('الحالات الناجحة')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="success_relations-icon" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('success_relations.index')}}">{{__('قائمة الحالات الناجحة')}}</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#Common-icon">
                            <div class="pull-left"><i class="fas fa-users"></i><span class="right-nav-text">{{__('الاسئلة الشائعة')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="Common-icon" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('common_questions.index')}}">{{__('قائمة الاسئلة الشائعة')}}</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#Aboutus-icon">
                            <div class="pull-left"><i class="fas fa-users"></i><span class="right-nav-text">{{__('نبذة عن صوفيا ')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                    ...
                    <!-- App Features -->
                     <li>
                        ...
                        <ul id="app_features-menu" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('app_features.index')}}">{{__('مـمـيـزات الـتـطـبـيـق') }}</a></li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#privacy-icon">
                            <div class="pull-left"><i class="fas fa-users"></i><span class="right-nav-text">{{__('الشروط / سياسة الخصوصية')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                    ...
                    <li>
                        ...
                        <ul id="homepage_word-menu" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('homepage_words.index')}}">{{('كلمة الصفحة الرئيسية')}}</a></li>                        </ul>
                    </li>
